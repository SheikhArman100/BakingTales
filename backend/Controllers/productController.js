...
const createProduct=async (req, res) => {
  ...
  // get cake product
  const getCakeProduct=async (req, res) => {
  
  
    try {
      const products=await Product.find({catagories:"Cake"})
      res.json(products)
    } catch (error) {
      console.log(error)
    }
  ...
  const getCupcakeProduct=async (req, res) => {
  
  
    try {
      const products=await Product.find({catagories:"Cupcake"})
      res.json(products)
    } catch (error) {
      console.log(error)
    }
...
// get brownies product
  const getBrowniesProduct=async (req, res) => {
  
  
    try {
      const products=await Product.find({catagories:"Brownies"})
      res.json(products)
    } catch (error) {
      console.log(error)
    }
...
module.exports = {
    createProduct,updateProduct,deleteProduct,getProduct,getAllProduct,getPopularProduct,getCakeProduct,getCupcakeProduct,getBrowniesProduct
}